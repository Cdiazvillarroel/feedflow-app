      ...
      <div style={{ width: '100%', maxWidth: 400 }}>
        ...
        <div style={{ background: '#fff', borderRadius: 14, border: '0.5px solid #e8ede9', padding: '32px 28px' }}>
          ...
          <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div>
              <label style={{ display: 'block', fontSize: 12, fontWeight: 600, color: '#1a2530', marginBottom: 6 }}>
                Email
              </label>
              <input
                type="email"
                ...
                placeholder="admin@feedflow.com"
                required
            ...
            <button
              type="submit"
              disabled={loading}
              style={{ width: '100%', padding: '11px', background: loading ? '#aab8c0' : '#4CAF7D', border: 'none', borderRadius: 8, fontSize: 14, fontWeight: 600, color: '#fff', cursor: loading ? 'not-allowed' : 'pointer', fontFamily: 'inherit' }}
            >
